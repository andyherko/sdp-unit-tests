...
-- MAGIC
-- MAGIC You can open the <a dbdemos-pipeline-id="sdp-test" href="#joblist/pipelines/4279cd54-f7ad-4c52-8c96-d4ecc28c342f">Spark Declarative Pipelines Pipeline for unit-test</a> to see the tests in action